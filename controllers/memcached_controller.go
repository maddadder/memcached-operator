...
import (
	...
	cachev1alpha1 "github.com/maddadder/memcached-operator/api/v1alpha1"
)

const memcachedFinalizer = "cache.master-0.local/finalizer"
...
//+kubebuilder:rbac:groups=cache.master-0.local,resources=memcacheds,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=cache.master-0.local,resources=memcacheds/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=cache.master-0.local,resources=memcacheds/finalizers,verbs=update
